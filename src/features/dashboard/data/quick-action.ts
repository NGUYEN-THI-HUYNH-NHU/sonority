...
export const quickActions: QuickAction[] = [
  ...
  },
  {
    ...
    href: "/text-to-speech?text=The rain hammered against the window as Lena turned to face Miu. You knew, didn't you? Lena whispered, her voice barely holding together. Miu stepped forward, jaw clenched. I did what I had to do. The silence between them was louder than the storm outside.",
  },
  {
